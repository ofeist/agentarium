...
- should the demo keep each step as explicit code, or use a tiny ordered list of steps
- whether adding a helper-level unit test is worth the added mocking
- whether README wording needs any change if the commands and behavior remain the same
